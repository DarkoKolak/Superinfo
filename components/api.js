...
class Api extends React.Component{
    ...
    render(){
        ...
        return(
            ...
            renderItem={({item} ) =>
            <View>
                 { <PocetnaObjava navigation={this.props.navigation} content={item.content.rendered} date={item.date_gmt} title={item.title.rendered} image={item.jetpack_featured_media_url}  /> }
             </View>
                 }  />
         </View>
